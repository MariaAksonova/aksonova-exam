<?php
/**
 * aksonova-exam functions and definitions
 *
...
if ( ! function_exists( 'aksonova_exam_setup' ) ) :
/**
 ...
 */
function aksonova_exam_setup() {
	/*
	 * Make theme available for translation.
	 * Translations can be filed in the /languages/ directory.
	 * If you're building a theme based on aksonova-exam, use a find and replace
	 * to change 'aksonova-exam' to the name of your theme in all the template files.
	 */
	load_theme_textdomain( 'aksonova-exam', get_template_directory() . '/languages' );
	...
	add_theme_support( 'custom-background', apply_filters( 'aksonova_exam_custom_background_args', array(
...
add_action( 'after_setup_theme', 'aksonova_exam_setup' );
 ...
 */
function aksonova_exam_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'aksonova_exam_content_width', 640 );
}
add_action( 'after_setup_theme', 'aksonova_exam_content_width', 0 );
 ...
 */
function aksonova_exam_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'aksonova-exam' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'aksonova-exam' ),
...
add_action( 'widgets_init', 'aksonova_exam_widgets_init' );

/**
 * Enqueue scripts and styles.
 */
function aksonova_exam_scripts() {
	wp_enqueue_style( 'aksonova-exam-style', get_stylesheet_uri() );
...
add_action( 'wp_enqueue_scripts', 'aksonova_exam_scripts' );
